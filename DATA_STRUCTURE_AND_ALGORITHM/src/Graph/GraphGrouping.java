...
public class GraphGrouping {
    ...
    public static void main(String[] args) {
        GraphGrouping solution = new GraphGrouping();
        int[][] edges1 = {{1,2},{1,4},{1,5},{2,6},{2,3},{4,6}};
        System.out.println(solution.magnificentSets(6, edges1)); // Output: 4

        int[][] edges2 = {{1,2},{2,3},{3,1}};
        System.out.println(solution.magnificentSets(3, edges2)); // Output: -1
    } 
}
